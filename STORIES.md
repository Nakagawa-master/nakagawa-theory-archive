...
理論名を覚える必要はありません。  
まず、見覚えのある問題を1本だけ読んでください。

- [「エラーだったから、もう一度押した」──二重決済が起きることがある](human-translation/entry-stories/01-double-charge-after-error.md)
- [今月は大成功。でも「次に使える手」が減っていたら？](human-translation/entry-stories/02-success-eats-tomorrow.md)
- [AIに3案出してもらって、自分で1つ選んだ。本当に自分で決めた？](human-translation/entry-stories/03-ai-made-the-menu.md)
...
このページは一般読者向けの公開入口です。正式な定義・成立条件は各リンク先の公式派生物・canonical sourceを優先します。
