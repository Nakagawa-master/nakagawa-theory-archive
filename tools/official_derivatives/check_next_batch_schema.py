...
EXTRA = ['check_derivative_registry_rows.py','check_derivative_registry_identity.py','check_derivative_registry_canonical.py','check_derivative_registry_page_parity.py','check_derivative_registry_boundary.py','check_effect_surface_map.py','check_effect_readiness.py','check_effect_force_keys.py','check_scale_keys.py','check_layer_keys.py','check_flow.py','check_stage_io.py','check_stage_conditions.py','check_activation_runbook.py']
...
def main():
    ...
    print('check_set=next_batch_schema_v17')
    if bad:
