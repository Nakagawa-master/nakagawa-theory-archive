...
EXTRA = ['check_derivative_registry_rows.py','check_derivative_registry_identity.py','check_derivative_registry_canonical.py','check_derivative_registry_page_parity.py']
...
def main():
    ...
    print('check_set=next_batch_schema_v6')
    if bad:
