...
- tools/official_derivatives/next_10_post_draft_validation_gate_candidate_10_19.tsv
...
- post-draft validation gate: post_draft_validation_ready
...
- the post-draft validation gate must later fail drafts that become thin summaries, generic text, originless text, parent-identity-losing text, causal-line-missing text, boundary-missing text, role-structure-missing text, or translation-thinned text
