...
# Public theory prose can contain normative claims that belong to the parent itself. These patterns target
# derivative/editor/reader-facing imperatives rather than every normative verb in the theory.
...
EN_AI=re.compile(r"\b(?:third[- ]party )?AI(?:s)?\b.{0,180}\b(?:must|should|shall|do not|must not|should not)\b",re.I)
