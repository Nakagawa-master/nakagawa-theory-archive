...
## State model
- CLOSED: 価値が蔵の内側・完成品の外側に残る。
- OPENING: 制度適合した造りの場を都市導線へ配置する。
- TRANSLATED: 造りたて、工程、食文化等を商品・体験へ翻訳する。
- CONNECTED: 生活者の日常接触と地域の素材・食・生産関係へ接続する。
- REDESIGNED: 造りそのものへのアクセス条件が事業構造として成立する。

## Applications
Fermenteria固有の構造記録として、文化・伝統産業・制作産業で完成品の外側に価値が残る場合の観測軸を与える。適用時は「誰が何へアクセスできなかったか」「どの制度・場所・商品・体験がそれを開くか」を確認する。無条件の他産業一般化はしない。

## Measurements and audit
- 造りの時間・現場への接触が実質化しているか。
- 都市立地が製造と消費の距離を縮めているか。
- 店舗内醸造が演出だけでなく現場アクセスとして機能しているか。
...
## Failure conditions
話題性だけが残る、造りの現場が演出化する、商品展開が価値核から切れる、地域接続が名目的になる、制度・運営・需要条件で継続できない、または社会翻訳が酒類消費促進・企業礼賛へ縮減される場合。

## Falsification conditions
造りの時間・現場・関係性へのアクセスが実際には生じない、都市配置が接触条件を変えない、商品・体験・地域接続を同一の価値核で説明できない、または別の因果説明が継続的に高い説明力を示す場合、本構造読解は縮小・修正される。

## Required distinctions
- Fermenteriaの確認可能な事実 / Nakagawa Masterの構造読解
