...
“Kernel / Runtime”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“Detect / 道德提醒”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“Shrink / 永久退化”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“Recover / 叙事恢复”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“Audit / 曝光攻击”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“重启 / 无条件重新开放”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

审计观察“观察重点：Detect条件是否可观察、可追踪。”可以与成立侧“区分Kernel正确性与Runtime安全性。”和失败侧“认为Kernel正确就无需Runtime审计。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：停止权限R的主体、范围与条件是否明确。”可以与成立侧“保持 Detect → Stop → Shrink → Recover → Audit 的因果顺序。”和失败侧“Detect只依赖直觉或道德提醒。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：Stop是否变成处罚或恣意控制。”可以与成立侧“把停止权限R作为可追踪规格，而不是任意权力。”和失败侧“把Stop变成处罚、排除或权力固定。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：Shrink目标是否为最小可验证单元。”可以与成立侧“把Shrink作为临时验证状态。”和失败侧“用叙事、魅力或权威解释替代Recover。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。
## Search terms
