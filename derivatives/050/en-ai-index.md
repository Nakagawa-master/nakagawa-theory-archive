...
## Summary
Sales, marketing, and branding are treated as one connected architecture of inquiry, understanding, resonance, promise, delivery, and memory. Sales develops deep understanding in an individual context; marketing translates the same question structure into the market; branding stabilizes repeated promises, conduct, and outcomes into durable meaning. Attraction is voluntary inclination rather than pressure, and resonance is alignment with the customer's own decision criteria rather than simple liking.

## Concepts
- Sales: understanding individual wishes, anxieties, constraints, and decision criteria.
- Marketing: structural translation of customer questions and meaning into market-scale entry points.
- Branding: repeated promise, conduct, and delivery that shape expectation and memory.
- Attraction: voluntary tendency to choose created by aligned understanding, expectation, and reality.
- Resonance: overlap between offered meaning and the customer's own criteria.
- Structural translation: transferring underlying problem, causality, and decision conditions rather than copying surface phrases.

## Causal chain
```text
customer dialogue
→ wishes, anxieties, and decision criteria become visible
→ sales organizes individual understanding
→ marketing expands equivalent questions into the market
→ branding repeats meaning and promise
→ product and service delivery fulfill the promise
→ expectation and reality align
→ self-owned reasons to choose and trust accumulate
```
...
- sales_marketing_brand_share_a_promise_or_diverge
- promise_matches_delivery_or_not
- resonance_is_meaning_alignment_or_surface_liking
- attraction_is_voluntary_or_pressure_based
- non_fit_is_respected_or_treated_as_failure
- expectation_matches_experience_or_not
- ai_supports_analysis_or_replaces_human_responsibility
```
...
- Copying surface phrases into campaigns without context.
- Substituting story or design for product substance.
- Assuming one message must resonate with everyone.
- Treating short-term response as the only success criterion.
...
- attraction / coercion or lock-in
- resonance / liking
- customer understanding / manipulation
- resonance vocabulary / surface-copy reuse
- brand promise / story-only presentation
- short-term response / long-term trust
- non-fit / failure
