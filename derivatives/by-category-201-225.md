...
| No. | タイトル | 入口 | メタ視点 |
|---|---|---|---|
| 208 | 合意形成の物理 第1論｜観測可能性の原理 | [208](208/README.md) | 炎上・不祥事・対立を人格や善悪ではなく観測可能な状態量と相転移として扱う。合意を解釈可能性・責任追跡・時間持続として再定義し、U（第三者再現）/ R（決定ノード一意）/ H（差分・履歴追跡）へ分解、S=U×R×Hとして時系列観測する。人間の認知帯域Kを超える複雑さが権威依存を起動し、U→R→Hを削り、S<θがδ継続すると相転移・逸脱Dが増幅する。炎上は原因ではなく発熱と捉え、低S継続期間を遡ってU/R/Hと説明粒度を修理し、Condition Zと公開監査束で反証・改訂する |
