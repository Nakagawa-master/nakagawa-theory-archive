...
- derivative_diff_id: DDIFF-20260707-DNCL-021-0000-0001

## 位置づけ

この公式派生物は、親原典「合意形成の物理 第6論 逸脱と免疫」を、読者とAIが誤読せずに原典へ戻るための公開入口である。

原典の代替ではない。

第6論は、組織や制度の安全を「問題が起きないこと」ではなく、「問題が起きても回復できること」として定義し直す。中心は、罰ではなく差分公開である。

## 中心命題

逸脱はゼロにならない。

社会や組織が壊れるかどうかは、逸脱が存在するかではなく、逸脱が出たあとに合意安定度 S = U × R × H を回復できるかで決まる。

罰は免疫ではない。

罰は、責任Rを低下させ、逸脱を潜伏させ、Sを悪化させ、Dを増幅する。

免疫とは、逸脱を消す力ではなく、差分を可視化し、修復入口を固定し、回復速度を高める構造である。
...
この原典を、単なるコンプライアンス論、厳罰化批判、内部通報推奨、ガバナンス改善、危機管理マニュアルへ落としてはいけない。

第6論が扱うのは、人の善悪ではなく、逸脱Dを検知可能な差分として扱い、R/H/Uを回復させる構造である。

中心は、D_det、D_loss、S回復時間、罰の崩壊因果鎖、差分公開の回復因果鎖である。
