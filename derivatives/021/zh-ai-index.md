...
“D_det增加 / 恶化”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“D_loss下降 / 仅仅报告增加”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“差分公开 / 透明性倡导”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

审计观察“观察重点：D_det增加是否同时伴随D_loss下降。”可以与成立侧“不把偏离为零定义为免疫。”和失败侧“把D_det增加自动视为恶化。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：D_det下降代表偏离减少，还是报告抑制。”可以与成立侧“把D_det、D_loss与S恢复时间一起读取。”和失败侧“认为更严厉惩罚必然提高免疫。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：差分公开后，R是否被固定为修复入口。”可以与成立侧“让R作为修复入口保持可追踪。”和失败侧“把透明度或公开量本身等同于免疫。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：H是否保留差分、变更理由和修复履历。”可以与成立侧“审计惩罚中心运作造成的潜伏与报告抑制。”和失败侧“缩约为一般举报促进或合规论。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：S恢复时间是否缩短。”可以与成立侧“防止公开变成曝光或报复。”和失败侧“把差分公开用于曝光、报复或针对个人攻击。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：加强惩罚是否增加报告抑制、潜伏或责任回避。”可以与成立侧“不把偏离为零定义为免疫。”和失败侧“给D_det、D_loss或恢复时间设置父原典未定义固定合格值。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：差分公开是否变成人身曝光、报复或攻击。”可以与成立侧“把D_det、D_loss与S恢复时间一起读取。”和失败侧“把D_det增加自动视为恶化。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：是否只根据被检测件数判断健康度。”可以与成立侧“让R作为修复入口保持可追踪。”和失败侧“认为更严厉惩罚必然提高免疫。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

父原典中的相关确认点是：用项“在内部举报系统中，不因举报数量增加就判定恶化，应同时观察D_loss、修复责任和恢复时间。”显示父原典的抽象结构如何回到可观察场景。其意义来自本索引所列的因果关系、审计点和成立／失败边界，而不是案例表面的分类名称本身。
## Search terms
