...
- parent_diff_id: DIFF-20251102-0001
- parent_post_id: 248
- origin_slug: nakagawa-master-question-depth-design
...
quality_targets:
  ...
  - PQ-5, D0-D5, SQS, metrics and boundaries retained
...
- D0–D5 retained: PASS
- SQS retained: PASS
- Inquiry Canvas and metrics retained: PASS
- FAQ three layers and 32 questions: PASS
- JA/EN/ZH structural equivalence: PASS
- coercion, pressure, authority and evidence boundaries: PASS
- origin return and mutual navigation: PASS
- private operations excluded: PASS
- official-derivatives-map registration: PENDING
- private Apps Script sync: PENDING
...
本派生物は検索・理解・接続面であり、親原典の代替ではない。PQ-5、D0–D5、SQS、監査、反証、起源宣言は親原典へ戻って確認する。
