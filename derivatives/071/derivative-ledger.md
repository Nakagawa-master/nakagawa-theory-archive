...
OD071は、初回から中核意味、README、人間向け要約、三言語の内容品質を保持した。一方、完全Factory gateとの突合でFAQ回答密度、FAQ第2層名、中国語identity正規表記、ledger固定セクションの調律が必要となったため、完全な一発PASSとは扱わない。上流と実ファイルの再調律後はPASSである。
