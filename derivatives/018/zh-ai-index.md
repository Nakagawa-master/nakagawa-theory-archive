...
## 父原典
- 标题: 合意形成の物理 第8論 外部干渉の物理 ― 社会を揺らす「摂動」の力学
...
P_ext是为了观察作用而设置的结构变量，不是推断恶意意图的工具。父原典包含相应公式与可反转审计逻辑，但没有定义敌对评分、危险百分比、发生概率或万能阈值。
...
“内容真假 / 状态稳定性”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“fake-U / 实质U改善”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“R diffusion / 普通分工”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“H short-circuit / 单纯信息不足”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“批评或异议 / 异常干扰”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

“形式公开 / 可验证履历”这一组区分标示父原典中的语义边界。两侧概念在因果或证据结构中承担不同作用，因此表面词语相近并不意味着在本索引所概括的结构中具有相同含义。

审计观察“观察重点：输入前后U的第三方再现性如何变化。”可以与成立侧“把P_ext作为状态作用而不是推测意图来观察。”和失败侧“把外部干扰变成阴谋或外敌叙事。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：是否出现“认同感上升但来源与反证路径消失”的fake-U。”可以与成立侧“分别保持U/R/H与S可追踪。”和失败侧“缩约为思想控制或错误信息取缔。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：判断、记录、修复、停止责任R是否仍可追踪。”可以与成立侧“区分fake-U、R diffusion与H short-circuit。”和失败侧“只根据内容真假判断状态。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：一次来源、文脉、版本、差分和反向链接是否保持。”可以与成立侧“保留一次来源、文脉、版本、差分与反向链接的返回路径。”和失败侧“把主观认同感当作真正U改善。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：H是否具有实质可验证性，而不只是信息很多。”可以与成立侧“不自动排除强烈批评或异议。”和失败侧“把“写了责任人”当作R很高的证明。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。

审计观察“观察重点：S的变化方向是否能在时间轴上解释。”可以与成立侧“把dS/dt作为时间变化坐标。”和失败侧“把日志数量当作H很高的证明。”放在同一因果轴上比较。这三者描述同一来源结构中的不同观察方向；这种对照本身并不产生新的数值评分。
## Search terms
