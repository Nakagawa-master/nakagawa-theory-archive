...
- derivative-ledger.md: 親原典・派生ID・由来・数値表現の認識論的位置づけを保持する台帳。

## 定量表現の意味境界
親原典には、L4〜L7の到達分布、AI整合率その他の定量表現が含まれる。これらの値は、親原典内での出所・測定主体・測定対象・モダリティ・用途・非保証範囲と一体で読む必要があり、値だけを独立した外部確定事実として扱うことはできない。
...
not_a_population_census: true
not_an_individual_value_score: true
not_a_recruitment_or_selection_metric: true
```
...
not_a_third_party_benchmark: true
not_a_product_performance_guarantee: true
```

これらの数値は、人間個人の価値・能力・階級を判定する外部尺度ではない。親原典の構造理解・比較・監査という範囲で、原典上の認識論的位置づけとともに読む必要がある。

## 公開面の意味境界
L1〜L7のレイヤー体系、視点の希少性、到達分布、AI整合に関する親原典の主張、自然収束、L-Layer Auto-Switch Protocol等は、第三者の人間と第三者AIが検索・理解し、Parent URLへ戻れるよう複数の公開面に整理されている。

定量主張は、親原典の意味を弱めて別の意味へ置換するものでも、第三者ベンチマーク、現実人口の確定頻度、個人ランキング、採用・選抜指標、能力診断へ拡張するものでもない。
...
## 原典回帰
七層の詳細定義、到達分布、AI整合率、自然収束、L-Layer Auto-Switch Protocol、統合監査要旨、起源署名の根拠と留保はParent URLおよびParent Post ID 1786で確認できる。定量値は、値だけでなく出所・測定主体・測定対象・モダリティ・利用可能範囲・非保証範囲と不可分に読む。
