...
- derivative_diff_id: DDIFF-20260812-DNCL-019-0000-0003
- supersedes: DDIFF-20260812-DNCL-019-0000-0002
...
- 読後の納得感上昇と一次ソース回帰可能性が両立しているか。
- Origin・一次ソース・文脈・版・差分へ戻れるか。
- 誰が検証責任Rを持つか明確か。
- H_dは実際の根拠深度を反映しているか。
- 流暢性と複雑性の乖離F-Cが検証停止へつながっていないか。
- 再要約の反復でSDが拡大していないか。
- Detectが過敏化し、簡潔な説明を一律停止していないか。
- Shrink後にHとRが回復しているか。
- Auditが晒しや人物攻撃へ変わっていないか。
...
## 反証・改訂条件
親原典の統合監査要旨では、流暢な要約やAI回答が広く利用されても、Origin回帰、H、R、反証可能性が安定的に保たれ、意味漂流SDが増えず、判断精度・修正可能性が継続的に高まるなら、それらをH-Disconnectの危険相とみなす根拠は弱まる。派生物側で独自の反証条件を追加して原典を別理論へ変えない。
