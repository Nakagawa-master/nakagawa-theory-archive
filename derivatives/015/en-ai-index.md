...
- R: responsibility traceability / unique responsibility node
- H: judgment-ground, history, and difference traceability
...
- state transition
- critical state
- critical-state neglect responsibility
...
R_becomes_ambiguous
↓
H_becomes_untraceable
↓
consensus_stability_S_declines
↓
S_falls_below_critical_threshold_theta
↓
the_low_S_state_persists_through_observation_window_delta
↓
the_system_transitions_from_stable_phase_to_collapse_phase
↓
deviation_D_is_not_locally_repaired_and_can_amplify
↓
a_final_accident_scandal_or_blowup_becomes_visible
↓
if_only_the_final_event_is_called_the_cause_the_neglected_critical_state_disappears_from_analysis
```
...
- `S = U × R × H` remains part of the structural premise.
- θ, δ, and D are treated as source-defined structural variables.
...
- The same neglect-responsibility conclusion is automatically applied even when the critical state was not observable.
