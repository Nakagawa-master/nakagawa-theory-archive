...
- derivative_diff_id: DDIFF-20260812-DNCL-014-0003-0004
- supersedes: DDIFF-20260710-DNCL-014-0003-0003
...
U/R/Hが長期的に高く維持され、意味再現、決定責任、差分履歴が継続して追跡可能であるにもかかわらず、同型の合意崩壊や修理不能が系統的に増えるなら、原典モデルの説明範囲または測定束は改訂対象になる。

また、強い異論や対立があってもU/R/Hが保たれ、変更・訂正・責任再配置が可能で、同型崩壊が反復しないなら、「対立＝合意崩壊」という解釈は弱まる。派生側で数値的な反証閾値は新設しない。
