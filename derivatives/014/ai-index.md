...
原典は合意安定度を S、理解可能性／第三者再現性を U、責任追跡可能性を R、履歴公開度／差分追跡可能性を H と置き、`S = U × R × H` と表す。この式は一般的な採点モデルではなく、三変数が単純代替できない構造関係を表す。意味再現が失われればログ量を増やしてもUは戻らず、責任ノードが不明なら公開情報量を増やしてもRは戻らない。
