...
“未来会产生成本”是否就等于“未来负债”？如何在同一条因果线上理解当下受益与留给未来的未结算部分？

- [Future Debt first note](discovery-notes/future-debt-is-not-every-future-cost.md)
- [中文叙事入口｜今天的成功是否正在减少明天的选择？](discovery-notes/today-success-tomorrow-options.zh.md)
...
人员更换、规则增加后，同样的问题仍然出现时，是否是角色边界、信息路径、权限、责任、交接或制度配置没有连接好？
...
一个组件能运行、一个PoC成功，并不一定代表整个业务或系统已经成立。
