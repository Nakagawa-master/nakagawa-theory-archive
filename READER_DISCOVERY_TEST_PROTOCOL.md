...
## D5 — recurring motif → compare two independent sources
...
- The matrix is discoverable from the public repository.
- Both linked official derivatives open correctly.
- Each source exposes its own Parent identity and provenance.
- The proposed motif can be checked from the actual source positioning / central proposition / causal line rather than accepted only from the matrix wording.
